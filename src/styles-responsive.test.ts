...
describe("small mobile responsive CSS", () => {
  ...
  it("includes dedicated layout tightening for 320px screens", () => {
    ...
    expect(styles).toContain("--hero-overlay-bottom: rgba(255, 250, 248, 0.72);");
    expect(styles).toContain("rgba(255, 250, 248, 0.52) 82%");
    expect(styles).toContain(".confidence-section::before");
    expect(styles).toContain(".confidence-section::after");
    expect(styles).toContain("top: 0");
    expect(styles).toContain("top: -26px");
    ...
    expect(styles).toContain("backdrop-filter: blur(12px) saturate(1.03)");
    expect(styles).toContain("rgba(255, 253, 249, 0.55) 28%");
    expect(styles).toContain("rgba(255, 253, 249, 0.9) 68%");
    expect(styles).toContain("rgba(255, 253, 249, 0.42) 30%");
    expect(styles).toContain("rgba(255, 253, 249, 0.74) 70%");
    expect(styles).toContain("z-index: 1;");
