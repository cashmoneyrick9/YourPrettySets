...
describe("small mobile responsive CSS", () => {
  ...
  it("includes dedicated layout tightening for 320px screens", () => {
    ...
    expect(styles).toContain("rgba(255, 250, 248, 0.44) 84%");
    ...
    expect(styles).toContain("background: linear-gradient(180deg, rgba(255, 250, 248, 0) 0%, rgba(255, 250, 248, 0.34) 48%, #fffaf8 100%)");
    expect(styles).toContain("background: radial-gradient(ellipse at 50% 52%");
    ...
    expect(styles).toContain("0 14px 26px rgba(93, 48, 67, 0.07)");
