...
describe("small mobile responsive CSS", () => {
  ...
  it("includes dedicated layout tightening for 320px screens", () => {
    ...
    expect(styles).toContain("z-index: 1;");
    expect(styles).toContain("0 10px 24px -14px rgba(93, 48, 67, 0.18)");
    ...
    expect(styles).toContain("--confidence-card-height: 124px;");
    ...
    expect(styles).toContain("transition: transform 4800ms linear");
