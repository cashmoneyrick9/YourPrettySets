...
describe("small mobile responsive CSS", () => {
  ...
  it("includes dedicated layout tightening for 320px screens", () => {
    ...
    expect(styles).toContain("--hero-overlay-bottom: rgba(255, 244, 239, 0.34);");
    expect(styles).not.toContain("rgba(255, 250, 248, 0.52) 82%");
    ...
    expect(styles).toContain("background: radial-gradient(ellipse at 50% 38%");
