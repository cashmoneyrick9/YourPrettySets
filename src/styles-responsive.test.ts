...
describe("small mobile responsive CSS", () => {
  ...
  it("keeps the FAQ Help section aligned to the shared neutral system", () => {
    ...
    expect(faqStyles).toContain("linear-gradient(145deg, #26313b 0%, #17212a 58%, #101820 100%);");
    expect(faqStyles).toContain(".faq-help__cta-row");
    expect(faqStyles).toContain(".faq-help__primary-link");
    expect(faqStyles).toContain(".faq-help__secondary-link");
    ...
    expect(faqStyles).toContain(".faq-question-card {\n  background: var(--site-surface);");
    expect(faqStyles).toContain("box-shadow: var(--site-shadow-soft);");
    expect(faqStyles).toContain(".faq-trust-strip {\n  background:");
    expect(faqStyles).toContain("grid-template-columns: repeat(3, minmax(0, 1fr));");
    expect(faqStyles).toContain(".faq-trust-strip__item + .faq-trust-strip__item");
