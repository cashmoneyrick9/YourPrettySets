...
- The live section now uses centered `HOW IT WORKS` / `3 easy steps` heading copy, three swipeable mobile cards, no visible progress bars, no swipe hint, and desktop three-column layout.
